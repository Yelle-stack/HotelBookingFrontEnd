    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
     ...
     <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>
            Guests will be allocated a ground floor apartment depending on availability. You will stay in a comfortable two-bedroom apartment with a true city atmosphere. The price quoted is for two guests. Please select the number of guests when booking to receive the exact price for larger groups.
        </p>
      </div>
      ...
      <div className='flex flex-col items-start gap-4'>
         <div className='flex gap-4'>
            <img src="/owner.svg" alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full'/>
            <div>
